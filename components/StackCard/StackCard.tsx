...
export function StackCard({ name, icon, description }: StackCardProps) {
    ...
    return (
        <div className="h-[511px] w-full max-w-[367px] overflow-hidden rounded-32 border-6 border-secondary-50">
            ...
            {description && (
                <p className="mt-32 px-32 text-center font-medium text-base-50">
                    {description}
                </p>
            )}
        </div>
